...
class MmCreateCollectionModal extends HTMLElement {
    ...
    connectedCallback() {
        ...
        Promise.all([
            ...
            const createCollectionForm = bdoc.ele(
                ...
                bdoc.ele(
                    ...
                    bdoc.ele(
                        ...
                        bdoc.ele(
                            ...
                            "Create Collection and Edit",
                            bdoc.eventListener("click", () => {
                                createCollectionForm.onSettled = onSettled(
...
customElements.define("mm-create-collection-modal", MmCreateCollectionModal);
