...
class MmCustomSets extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const customSetRows = Object.keys(customSets).map((key) => {
            ...
            return bdoc.ele(
                ...
                bdoc.ele(
                    ...
                    bdoc.ele(
                        "a",
                        bdoc.attr("href", `/c/ViewCustomSet?key=${key}`),
                        key
                    )
                ),
        ...
        const displayPropertyTitles = MmCustomSets.#displayProperties.map(
            (prop) => {
        ...
        bdoc.append(
            ...
            bdoc.ele(
                ...
                bdoc.ele(
                    ...
                    bdoc.ele("tbody", bdoc.id("table-body"), ...customSetRows)
                )
            )
        );
    }
